...
```
  ...
  ```
- **✅[多开微信]()**：```原生支持多开微信```
- **✅[附近人](doc/社交/获取附近的人.md)**：```支持添加[附近的人]```
- **✅[语音条](doc/发送消息/发送语音.md)**：```融合安卓版本[发送语音条]```
- **✅[视频号](doc/视频号)**：```融合安卓版本[视频号API]```
- **✅[朋友圈](doc/朋友圈)**：```融合安卓版本[朋友圈API]```
- **✅[直播间](doc/直播间)**：```融合安卓版本[直播间API]```
- **✅[公众号API](doc/公众号)**：```融合安卓版本[公众号API]```
...
- [🚀 **版本说明**](doc/readme/版本说明.md)，了解不同版本权益及价格。
